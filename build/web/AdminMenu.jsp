...
<html>
    ...
    <body>
        <%
            ...
            String username = getServletContext().getAttribute("usernameadmin").toString();
        %>
         <nav class="navbar navbar-inverse navbar-fixed-top">
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav menu">
                    <li><a href="AdminFeedback.jsp">Phản hồi</a></li>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li><img src="./img/logo.png" alt="User Avatar" class="img-circle" width="40px" height="40px"></li>
                    <li id="AdminName"><%=username%></li>
